...
%	Le simulazioni sono state condotte assumendo una frequenza di campionamento $f_{s}=\SI{16}{\kilo\hertz}$.
	...
	\begin{figure}[H]
		\centering
		\includegraphics[width=\textwidth]{diagrams/setup_1x1_ASIO}
		\caption{text}
	\end{figure}
	
	\begin{figure}[H]
	\centering
	\includegraphics[width=\textwidth]{diagrams/setup_2x2_ASIO}
	\caption{text}
	\end{figure}
	...
	Il materiale è 
	Casse Genelec 8020A x2
	Microfono Beringer B-5 x2
	Scheda audio focusrite Scarlett 2i2.
	
	
	Sono state svolte, tutte in camera Semianecoica “E. Mattei” (Audio DSP Lab), tre prove in tre configurazioni diverse, inizialmente riportate con lo schema seguente
	
	cassa sx e microfono sx sullo stesso asse a distanza 153 cm. cassa dx e microfono dx sullo stesso asse a distanza 143 cm. la distanza tra i due assi è di 94 cm.
	
	La seconda prova è stata svolta con i seguenti parametri 
	sempre cassa e microfono sullo stesso asse.
	distanza tra gli assi 50cm
	distanza tra cassa e microfono 55cm in entrambi i casi
	
	La terza prova è stata svolta 
	sempre cassa e microfono sullo stesso asse.
	distanza tra gli assi 50cm
	distanza tra cassa e microfono 25cm in entrambi i casi
