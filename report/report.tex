...
%	Le simulazioni sono state condotte assumendo una frequenza di campionamento $f_{s}=\SI{16}{\kilo\hertz}$.
	...
	\subsection{Latenza e dimensionamento dei buffer}
	...
	Lavorando a 16 campioni il margine di CPU è quindi minimo, e la lunghezza delle \ac{rir} stimate è stata dimensionata di conseguenza.
	...
	Nella ptova 2 il picco al campione 287 corrisponde alla stessa latenza più i 71 campioni dei \SI{55}{\centi\meter}. 
